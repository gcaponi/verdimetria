...
heartbeat mirror oltre 8 ore. I comandi esterni hanno timeout di 60s; se il
lock e' gia' preso, il run esce 0 dopo un log `lock occupato, skip run`.
I marker in `/var/lib/verdimetria-monitor/`
